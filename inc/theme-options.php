...
function majestic_tube_options_map() {
	...
	$map_value = array(
		...
		'logo-font-family'         => array(
			...
			'section'     => $branding,
			'description' => __( 'Each family below ships with the theme, so the logo changes face immediately. The System choices use the fonts already installed on each visitor device. The logo is drawn at a heavy weight; Lato ships no ExtraBold face, so its Bold face is used.', 'majestic-tube' ),
			'choices'     => array(
				'Inter'            => 'Inter',
				'Open Sans'        => 'Open Sans',
				'Roboto'           => 'Roboto',
				...
				'System UI'        => __( 'System UI (sans serif)', 'majestic-tube' ),
